...
{
    public class DogDbDataAdapter: DbDataAdapter
    {
        public DogDbDataAdapter(DbDataAdapter innerDataAdapter)
        {
        ...
        public override int Fill(DataSet dataSet)
        {
            ...
            {
                var typedCommand = SelectCommand as DogDbCommand;
        ...
        {
            var typedCommand = command as DogDbCommand;
