...
{
    public class DogDbDataReader:DbDataReader
    {
        private IMessageBroker messageBroker;

        public DogDbDataReader(DbDataReader dataReader, DbCommand command, Guid connectionId, Guid commandId)
        {
        ...
        public DogDbDataReader(DbDataReader dataReader, DbCommand command, Guid connectionId, Guid commandId, IMessageBroker messageBroker)
